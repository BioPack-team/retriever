...
class Edge:
    ...
    def from_dict(  # noqa: PLR0913
        ...
        _INTERMEDIATE_PREFIXES = ("intermediate_", "intermediateA_", "intermediateB_")
        node_is_subclass_of_expansion = raw_node_binding.startswith(_INTERMEDIATE_PREFIXES)
        ...
        if node_is_subclass_of_expansion:
            ...
            matched_prefix = next(p for p in _INTERMEDIATE_PREFIXES if raw_node_binding.startswith(p))
