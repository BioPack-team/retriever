...
import { SerializableLog } from "@retriever/utils";
...
const debug = Debug("retriever:call-apis:relay");

const subqueryDispatcher = new SubqueryDispatcher();

export { default as Subquery } from "./queries/subquery";
...
export default class SubqueryRelay {
  subscriberMap: {
